...
<div class="page-header"><h2> {{ $pageTitle }} <small> {{ $pageNote }} </small> </h2></div>
	...
	{!! Form::open(array('url'=>'variation?return='.$return, 'class'=>'form-horizontal validated sximo-form','files' => true ,'id'=> 'FormTable' )) !!}
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$("#product_id").jCombo("{!! url('variation/comboselect?filter=product:id:title') !!}",
		{  selected_value : '{{ $row["product_id"] }}' });
		 	
		 	 

		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("variation/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
