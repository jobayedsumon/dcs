...
class MembershipaccreditationController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'membershipaccreditation';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Membershipaccreditation();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'membershipaccreditation',
	...
	public static function display(  )
	{
		...
		$model  = new Membershipaccreditation();
		$info = $model::makeInfo('membershipaccreditation');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('membershipaccreditation.public.view',$data);			
			}			
		} 
		else {
			...
			return view('membershipaccreditation.public.index',$data);	
		}
