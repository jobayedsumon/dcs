...
class DcsgallaryController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'dcsgallary';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Dcsgallary();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'dcsgallary',
	...
	public static function display(  )
	{
		...
		$model  = new Dcsgallary();
		$info = $model::makeInfo('dcsgallary');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('dcsgallary.public.view',$data);			
			}			
		} 
		else {
			...
			return view('dcsgallary.public.index',$data);	
		}
