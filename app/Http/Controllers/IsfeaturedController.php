...
class IsfeaturedController extends Controller {
	...
	public $module = 'isfeatured';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Isfeatured();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'isfeatured',
	...
	public static function display(  )
	{
		...
		$model  = new Isfeatured();
		$info = $model::makeInfo('isfeatured');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('isfeatured.public.view',$data);			
			}			
		} 
		else {
			...
			return view('isfeatured.public.index',$data);	
		}
