...
class DcsfaqController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'dcsfaq';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Dcsfaq();	
	...
	public static function display(  )
	{
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('dcsfaq.public.view',$data);			
			}			
		} 
		else {
			...
			return view('dcsfaq.public.index',$data);	
		}
