...
class CareerrequestController extends Controller {
	...
	public $module = 'careerrequest';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Careerrequest();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'careerrequest',
	...
	public static function display(  )
	{
		...
		$model  = new Careerrequest();
		$info = $model::makeInfo('careerrequest');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('careerrequest.public.view',$data);			
			}			
		} 
		else {
			...
			return view('careerrequest.public.index',$data);	
		}
