...
use App\Models\Sildertwo;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class SildertwoController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'sildertwo';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Sildertwo();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'sildertwo',
	...
	public static function display(  )
	{
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('sildertwo.public.view',$data);			
			}			
		} 
		else {
			...
			return view('sildertwo.public.index',$data);	
		}
