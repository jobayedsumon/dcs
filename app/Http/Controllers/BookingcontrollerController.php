...
use App\Models\Bookingcontroller;
...
class BookingcontrollerController extends Controller {
	...
	public $module = 'bookingcontroller';
	static $per_page	= '50';

	public function __construct()
	{
		parent::__construct();
		$this->model = new Bookingcontroller();

		$this->info = $this->model->makeInfo( $this->module);
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'bookingcontroller',
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('bookingcontroller');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('bookingcontroller.public.view',$data);
			}
		}
		else {
			...
			return view('bookingcontroller.public.index',$data);
		}

	}
	function store_public(Request $request)
	{
